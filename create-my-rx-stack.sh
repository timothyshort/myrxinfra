...
aws cloudformation update-stack --stack-name ${stackName} --template-url "https://s3.amazonaws.com/${s3Bucket}/templates/infrastructure-main.yaml" --parameters file://params/infrastructure-main-params.json --disable-rollback --capabilities CAPABILITY_NAMED_IAM
